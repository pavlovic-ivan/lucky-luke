...
variable "allow_update_branch" {
  description = "(Optional) Set to true to allow users to update a pull request branch when the base branch is out-of-date. (Default: null)"
  type        = bool
  default     = null
}

variable "squash_merge_commit_title" {
  description = "(Optional) The title of the commit that will be created when a pull request is merged using the squash merge method. (Default: 'Merge pull request {{pull_request_number}} from {{source_branch}}')"
  type        = string
  default     = null
}

variable "squash_merge_commit_message" {
  description = "(Optional) The message of the commit that will be created when a pull request is merged using the squash merge method. (Default: 'Squash and merge')"
  type        = string
  default     = null
}

variable "merge_commit_title" {
  description = "(Optional) The title of the commit that will be created when a pull request is merged using the merge commit method. (Default: 'Merge pull request {{pull_request_number}} from {{source_branch}}')"
  type        = string
  default     = null
}
...
variable "merge_commit_message" {
  description = "(Optional) The message of the commit that will be created when a pull request is merged using the merge commit method. (Default: 'Merge pull request {{pull_request_number}} from {{source_branch}}')"
  type        = string
  default     = null
}
