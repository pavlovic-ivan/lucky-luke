## Vendored Terraform Module

This module is a **vendored version** of the original Terraform module from [mineiros-io/terraform-github-repository](https://github.com/mineiros-io/terraform-github-repository).

### Original Repository
- **Source:** [https://github.com/mineiros-io/terraform-github-repository)
- **Version:** `commit/ee6001a0b791af814d7f0c015da0c7ca204f3fbe`

### Changes Made in the Vendored Module

#### Removed:
- `push_restrictions` and `blocks_creations` as part of the main resource block.

#### Added:
- New `restrict_pushes` block to handle push restrictions and branch locking.
- `force_push_bypassers`, `lock_branch`, and `require_last_push_approval` fields.
- `has_discussions`, `pages.build_type`, `allow_update_branch`, `squash_merge_commit_title`, `squash_merge_commit_message`, `merge_commit_title`, `web_commit_signoff_required`, `merge_commit_message` fields

#### Modified:
- Adjusted the handling of `required_pull_request_reviews` and `required_status_checks`.
